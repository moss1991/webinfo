...
const FuturesIndexDailyChart: React.FC<ComponentProps> = (props) =>{
  const _chart = useRef(null);
  const _data = null;

  const _draw_chart_one = ()=>{
  ...
  return (
    <div>
      <h1>TS指数:{ props.ts_code } 结算价走势</h1>
...
export default FuturesIndexDailyChart
